            ...
            <div className = "contianer-fluid ">
                <div className = "row ">
                    <div className = "col-10 mx-auto pop" >
                        ...
                        <strong><h3 className="card-title brand-name  centers fsize2">Apply for premium</h3></strong>
                            <br/><br/>
                            <p className="card-text  fsize" >Apply and get free courses to certify your skills and bost your resume </p>
                            <div className = "pop">
                            <a href="https://rzp.io/l/UnLNOUTzs" className="btn centers ">Apply Now</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="\studenthome" className="btn centers ">Apply later</a>
                            </div>
                        </div>
