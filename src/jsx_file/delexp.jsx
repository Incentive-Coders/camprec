...
class delexp extends Component {
    ...
    del_experience (){
        ...
        axios.post('https://camprec.herokuapp.com/api/student/delexp',body,{header})
    ...
    render(){
        return (
            ...
            <section className="image width height">
                                 <h3 className="card-title card_us"><strong>Delete experience</strong></h3>
                                    <Form className="addjb margin-top" >
                                        ...
                                        <FormItem>
                                        <div className="form-group margin-t">
                                            <Input type="TEXT" className="form-control" placeholder="Company" onChange={this.updatecompanys} required/>
                                        </div>
                                        </FormItem>
                                        <input type= "submit" className="btn margin-top margin-b" onClick={this.del_experience} id='button'  value="delete"/>
                                    </Form>
            </section>
            </>
        );
